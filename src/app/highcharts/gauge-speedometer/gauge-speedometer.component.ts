...
@Component({
  selector: 'app-gauge-speedometer',
  templateUrl: './gauge-speedometer.component.html',
  styleUrls: ['./gauge-speedometer.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class GaugeSpeedometerComponent implements OnInit {

  public gaugeData: Array<any> = [80];
  ...
  // getData() {
  //   console.log('hi');
  //   const a = Math.round((Math.random() - 0.5) * 20);
  //   console.log(a);
  //   if (a > 3) {
  //     this.gaugeData[0] = 100;
  //     console.log(this.gaugeData[0]);
  //   } else {
  //     this.gaugeData[0] = 20;
  //     console.log(this.gaugeData[0]);
  //   }
  ...
  chart3 = new Chart({
    ...
    series: [{
      ...
      data: [0.2, 0.8, 0.8, 0.8, 1, 1.3, 1.5, 2.9, 1.9, 2.6, 1.6, 3, 4, 3.6, 4.5, 4.2, 4.5, 4.5, 4, 3.1, 2.7, 4, 2.7, 2.3, 2.3, 4.1, 7.7, 7.1, 5.6, 6.1, 5.8, 8.6, 7.2, 9]
    }, {
      name: 'Vik',
      // tslint:disable-next-line:max-line-length
      data: [0, 0, 0.6, 0.9, 0.8, 0.2, 0, 0, 0, 0.1, 0.6, 0.7, 0.8, 0.6, 0.2, 0, 0.1, 0.3, 0.3, 0, 0.1, 0, 0, 0, 0.2, 0.1, 0, 0.3, 0, 0.1, 0.2, 0.1, 0.3, 0.3, 0, 3.1]
    }],
    navigation: {
      menuItemStyle: {
        fontSize: '10px'
